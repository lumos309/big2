...
from big2GameV2 import vectorizedBig2Games
...
class big2PPOSimulation(object):
    ...
    def __init__(self, sess, sessConfig=None, startingUpdate = 0, osStartingUpdate = 0, inpDim = 448, nGames = 8, nSteps = 20, nMiniBatches = 4, nOptEpochs = 5, lam = 0.95, gamma = 0.995, ent_coef = 0.01, vf_coef = 0.5, max_grad_norm = 0.5, minLearningRate = 0.000001, learningRate=0.00025, clipRange=0.2, saveEvery = 500, oppSamplingRate = 0.0, eta = 0.1):
