...
class big2Game:
    ...
    def reset(self):
        ...
        self.neuralNetworkInputs[1] = np.zeros((448,), dtype=int)
        self.neuralNetworkInputs[2] = np.zeros((448,), dtype=int)
        self.neuralNetworkInputs[3] = np.zeros((448,), dtype=int)
        self.neuralNetworkInputs[4] = np.zeros((448,), dtype=int)
    ...
    def updateNeuralNetworkInputs(self,prevHand, cPlayer):
        ...
        cardsRecord = np.intersect1d(prevHand, np.arange(1,37))
    ...
    def getCurrentState(self):
        return self.playersGo, self.neuralNetworkInputs[self.playersGo].reshape(1, 448), convertAvailableActions(self.returnAvailableActions()).reshape(1,1695)
